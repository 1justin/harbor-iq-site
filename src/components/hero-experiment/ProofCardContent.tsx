  ...
  >
    <div className="rounded-lg border border-ash/60 bg-linen/40 px-5 py-4">
      <div className="flex items-center justify-between">
        <span className="text-[15px] font-medium uppercase tracking-wider text-stone">
          Answer
        </span>
      ...
      <p className="mt-3 text-[21px] leading-relaxed text-charcoal">
      ...
      <div className="mt-4 inline-flex items-center gap-2 rounded-md border border-ash bg-paper px-3.5 py-2 text-[15px] text-charcoal">
