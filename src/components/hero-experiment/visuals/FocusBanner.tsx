...
export const FocusBanner: React.FC = () => (
  <div className="rounded-xl bg-interactive px-7 py-7">
    <div className="flex items-start gap-5">
      <div className="flex h-[64px] w-[64px] shrink-0 items-center justify-center rounded-lg bg-white/15">
      ...
      <div>
        <p className="text-[17px] font-semibold uppercase tracking-wider text-white/80">
          Your focus today
        </p>
        <p className="mt-2 text-[24px] leading-snug text-white">
