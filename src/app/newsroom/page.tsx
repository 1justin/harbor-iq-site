          ...
          <div className="grid grid-cols-1 md:grid-cols-[260px_1fr] gap-10 items-start">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-5 text-[17px] text-charcoal leading-relaxed">
                Justin Mayer is the founder of HarborIQ, where he is building the AI-native AMS and CRM for independent insurance agencies full time. He is a Fortune 100 product executive turned AI transformation operator. Previously, he led AI implementation and operational transformation across a portfolio of operating companies at a Chicago family office, driving $35M+ in value creation in seven months through AI infrastructure, automated workflows, and AI-powered process optimization. His prior AI SaaS company, Encube, was acquired by Hitchworks in 2021. At Life Fitness, a $1B Brunswick durable-goods firm, he managed a $420M global category P&amp;L and is a named inventor on 9 patents.
              </p>
